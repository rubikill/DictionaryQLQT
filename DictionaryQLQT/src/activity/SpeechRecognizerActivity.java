...
public class SpeechRecognizerActivity extends Activity implements
	...
	private void startSpeechRecognizer() {
		...
		localIntent.putExtra(RecognizerIntent.EXTRA_CALLING_PACKAGE,
	...
	private void showDialogNotAvailable() {
		...
		alertDialog
				.setMessage(getString(R.string.speechrecognizer_not_available));
	...
	public void onResults(Bundle results) {
		ArrayList<String> listTexts = results
