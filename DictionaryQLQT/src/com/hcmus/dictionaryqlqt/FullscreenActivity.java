...
public class FullscreenActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TabSpec tabSpecDictionary = tabHost
		  ...
		  .setIndicator(new IndicatorLayout(this, "Dictionary", R.drawable.tab_dictionary))
		...
		TabSpec tabSpecRecent = tabHost
		  .newTabSpec("Recent")
		  .setIndicator(new IndicatorLayout(this, "Recent", R.drawable.tab_recent))
